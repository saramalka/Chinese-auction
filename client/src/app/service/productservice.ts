...
export class ProductService {
    ...
    giftUrl:string='/api/Gifts'
    getProductsDataFromServer(): Observable<Product[]> {
        return this._http.get<Product[]>(this.giftUrl)
    }

    saveProductToServer(product: Product): Observable<boolean> {
        return this._http.post<boolean>(this.giftUrl, product)
    }

    deleteProductFromServer(product: Product) {
        console.log(`Attempting to delete product with ID: ${product.id}`);
        return this._http.delete(`${this.giftUrl}/${product.id}`);
      }
    editProductFromServer(product: Product) {
        return this._http.put(this.giftUrl + product.id, product)
    }

    getOneFromServer(id: number): Observable<Product> {
        return this._http.get<Product>(this.giftUrl+"=" + id)
    }

    post(product:Product): Observable<Product>{
       return this._http.post<Product>(this.giftUrl,product)
    }
    updateProduct(product:Product){
        return this._http.put<Product>(this.giftUrl+product.id,product)
     }
    getProductsData() {
        return [
            createProduct({
